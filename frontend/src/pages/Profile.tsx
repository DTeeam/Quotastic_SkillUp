import DisplayLikedProfileQuotesForm from "components/quote/Profile_quotes/DisplayLikedQuoteForm";
...
const Profile: FC = () => {
  return (
    <div>
      ...
      <div>
        <p className="orange">Liked</p>
        <DisplayLikedProfileQuotesForm />
      </div>
    </div>
  );
};
