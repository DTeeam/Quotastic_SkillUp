...
const DisplayRecentProfileQuotesForm: FC = () => {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
    useInfiniteQuery(
      "fetchProfileRecentQuotes",
      ({ pageParam = 1 }) => API.fetchProfileRecentQuotes(userID, pageParam),
      {
...
export default DisplayRecentProfileQuotesForm;
