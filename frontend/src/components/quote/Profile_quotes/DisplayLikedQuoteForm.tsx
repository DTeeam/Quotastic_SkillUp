...
const DisplayLikedProfileQuotesForm: FC = () => {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
    useInfiniteQuery(
      "fetchProfileLikedQuotes",
      ({ pageParam = 1 }) => API.fetchProfileLikedQuotes(userID, pageParam),
      {
...
export default DisplayLikedProfileQuotesForm;
